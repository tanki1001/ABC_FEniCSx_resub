...
print("Start of the main_soar.py script")
...
def fct_main_soar(
    ...
    simu.plot_radiation_factor(ax, freqvec, X_sol_MOR, s = 'SOAR_'+ str_ope)
    ...
    if save_ROM_results:
        ...
        filename = "MOR/SOAR" + data['geometry1'] + "_" + data['geometry2'] + "_" + data['ope'] + "_" + str(data['lc']) + "_" + str(data['dimP']) + "_" + str(data['dimQ']) + "_" + str(data['N'])+ "_" + str(data['f0']) + "Hz"
