...
#lc_list = np.arange(5e-3, 5e-2, 0.5e-3)
lc_list = [8e-3, 1e-2, 1.1e-2, 1.2e-2, 1.3e-2, 1.4e-2, 1.5e-2, 1.6e-2, 1.7e-2, 1.8e-2, 2e-2, 2.1e-2, 2.2e-2, 2.3e-2, 2.4e-2, 2.5e-2, 2.6e-2, 2.7e-2, 2.8e-2, 2.9e-2, 3e-2]
...
for lc in tqdm(lc_list):
    ...
    for ii in range(freqvec.size):
        ...
        problem = LinearProblem(a, f, petsc_options_prefix="abc_b2ptangFreqDep", petsc_options={"ksp_type": "gmres",
                                                                                            "pc_type": "lu",
